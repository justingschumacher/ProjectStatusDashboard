...
#     goal = forms.IntegerField(label='Goal Number:', help_text='Required')
#     name = forms.CharField(label='Goal Name:', max_length=128, help_text='Required')
#     owner = forms.CharField(label='Owning Director:', max_length=128, help_text='Required')
#     group = forms.CharField(label='Owning Group:', max_length=128, help_text='Required')
